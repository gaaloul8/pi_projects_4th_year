...
public interface IReclamationService {
    Reclamation createReclamation(Reclamation reclamation, MultipartFile imageFile , HttpServletRequest request) throws IOException;
    ...
    List<Reclamation> getReclamationsByUserId(Integer userId);
